...
| Condition | Score |
|---|---|
| C1 Pathway Sufficiency | 0.990 |
| C2 Statistical Sufficiency | 0.465 |
| C3 Phenotypic Coverage | 0.182 |
| C4 Intersectional Sufficiency | 0.024 |
| **Overall CDS Score** | **0.530** (threshold: 0.75) |
...
**REJECTED** — CDS 0.530, HIPAA=YES, FDA SaMD=NO, EU AI Act=NO
...
---
*Raw stage-by-stage log: `topic_heart_admission_urgency_20260715_232232.txt`*
