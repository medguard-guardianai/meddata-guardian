...
| Condition | Score |
|---|---|
| C1 Pathway Sufficiency | 0.902 |
| C2 Statistical Sufficiency | 0.292 |
| C3 Phenotypic Coverage | 0.645 |
| C4 Intersectional Sufficiency | 0.220 |
| **Overall CDS Score** | **0.592** (threshold: 0.75) |
...
8,159 additional patients recommended, estimated cost $12,238,500.
Solver: Optimal (true MILP optimum)

## Stage 6 — Final Verdict

**REJECTED** — CDS 0.592, HIPAA=YES, FDA SaMD=NO, EU AI Act=NO
...
---
*Raw stage-by-stage log: `topic_diabetes_insurance_20260715_193855.txt`*
